      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        zzAtEOF = true;
            ...
            case COMMENT: {
              ...
              System.out.println("action [206] { yybegin(YYINITIAL);return newSym(sym.ERROR, \"EOF in comment\"); }");
    ...
    return newSym(sym.EOF);
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          case 1: 
            ...
            System.out.println("action [183] { return newSym(sym.CONSTANT, new Integer(yytext())); }");
            { return newSym(sym.CONSTANT, new Integer(yytext()));
            }
          case 100: break;
          case 2: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [208] { System.out.print(yytext() + \" \"); }");
            { System.out.print(yytext() + " ");
            }
          case 101: break;
          case 3: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [195] { return newSym(sym.ERROR, yytext()); }");
            { return newSym(sym.ERROR, yytext());
            }
          case 102: break;
          case 4: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [178] { return newSym(sym.ID, yytext()); }");
            { return newSym(sym.ID, yytext());
            }
          case 103: break;
          case 5: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [159] { return newSym(sym.AND); }");
            { return newSym(sym.AND);
            }
          case 104: break;
          case 6: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [157] { return newSym(sym.MULT); }");
            { return newSym(sym.MULT);
            }
          case 105: break;
          case 7: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [137] { return newSym(sym.DOT); }");
            { return newSym(sym.DOT);
            }
          case 106: break;
          case 8: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [186] { /* Ignore whitespace. */ }");
            { /* Ignore whitespace. */
            }
          case 107: break;
          case 9: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [132] { return newSym(sym.RBRACE); }");
            { return newSym(sym.RBRACE);
            }
          case 108: break;
          case 10: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [158] { return newSym(sym.DIV); }");
            { return newSym(sym.DIV);
            }
          case 109: break;
          case 11: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [196] { System.out.println(\"Illegal char, \'\" + yytext() +\"\' line: \" + yyline + \", column: \" + yychar); }");
            { System.out.println("Illegal char, '" + yytext() +"' line: " + yyline + ", column: " + yychar);
            }
          case 110: break;
          case 12: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [129] { return newSym(sym.LPAREN); }");
            { return newSym(sym.LPAREN);
            }
          case 111: break;
          case 13: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [130] { return newSym(sym.RPAREN); }");
            { return newSym(sym.RPAREN);
            }
          case 112: break;
          case 14: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [131] { return newSym(sym.LBRACE); }");
            { return newSym(sym.LBRACE);
            }
          case 113: break;
          case 15: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [142] { return newSym(sym.LT); }");
            { return newSym(sym.LT);
            }
          case 114: break;
          case 16: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [162] { return newSym(sym.MOD); }");
            { return newSym(sym.MOD);
            }
          case 115: break;
          case 17: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [141] { return newSym(sym.GT); }");
            { return newSym(sym.GT);
            }
          case 116: break;
          case 18: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [133] { return newSym(sym.LBRACK); }");
            { return newSym(sym.LBRACK);
            }
          case 117: break;
          case 19: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [146] { return newSym(sym.COLON); }");
            { return newSym(sym.COLON);
            }
          case 118: break;
          case 20: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [134] { return newSym(sym.RBRACK); }");
            { return newSym(sym.RBRACK);
            }
          case 119: break;
          case 21: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [135] { return newSym(sym.SEMICOLON); }");
            { return newSym(sym.SEMICOLON);
            }
          case 120: break;
          case 22: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [136] { return newSym(sym.COMMA); }");
            { return newSym(sym.COMMA);
            }
          case 121: break;
          case 23: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [140] { return newSym(sym.EQ); }");
            { return newSym(sym.EQ);
            }
          case 122: break;
          case 24: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [143] { return newSym(sym.NOT); }");
            { return newSym(sym.NOT);
            }
          case 123: break;
          case 25: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [144] { return newSym(sym.COMP); }");
            { return newSym(sym.COMP);
            }
          case 124: break;
          case 26: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [145] { return newSym(sym.QUESTION); }");
            { return newSym(sym.QUESTION);
            }
          case 125: break;
          case 27: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [160] { return newSym(sym.OR); }");
            { return newSym(sym.OR);
            }
          case 126: break;
          case 28: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [155] { return newSym(sym.PLUS); }");
            { return newSym(sym.PLUS);
            }
          case 127: break;
          case 29: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [156] { return newSym(sym.MINUS); }");
            { return newSym(sym.MINUS);
            }
          case 128: break;
          case 30: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [161] { return newSym(sym.XOR); }");
            { return newSym(sym.XOR);
            }
          case 129: break;
          case 31: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [188] { buff.setLength(0); yybegin(STRING); }");
            { buff.setLength(0); yybegin(STRING);
            }
          case 130: break;
          case 32: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [202] {  }");
            { 
            }
          case 131: break;
          case 33: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [210] { yybegin(YYINITIAL); }");
            { yybegin(YYINITIAL);
            }
          case 132: break;
          case 34: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [226] { buff.append(yytext()); }");
            { buff.append(yytext());
            }
          case 133: break;
          case 35: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [213] { yybegin(YYINITIAL);  return newSym(sym.ERROR, \"Unterminated string constant\"); }");
            { yybegin(YYINITIAL);  return newSym(sym.ERROR, "Unterminated string constant");
            }
          case 134: break;
          case 36: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [212] { yybegin(YYINITIAL); System.out.println(\"buffer: \" + buff); return newSym(sym.STRING,buff); }");
            { yybegin(YYINITIAL); System.out.println("buffer: " + buff); return newSym(sym.STRING,buff);
            }
          case 135: break;
          case 37: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [184] { return newSym(sym.CONSTANT, new Double(yytext())); }");
            { return newSym(sym.CONSTANT, new Double(yytext()));
            }
          case 136: break;
          case 38: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [180] { return newSym(sym.MEM_ID, yytext()); }");
            { return newSym(sym.MEM_ID, yytext());
            }
          case 137: break;
          case 39: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [151] { return newSym(sym.ANDAND); }");
            { return newSym(sym.ANDAND);
            }
          case 138: break;
          case 40: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [170] { return newSym(sym.ANDEQ); }");
            { return newSym(sym.ANDEQ);
            }
          case 139: break;
          case 41: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [179] { return newSym(sym.POINTER_ID, yytext()); }");
            { return newSym(sym.POINTER_ID, yytext());
            }
          case 140: break;
          case 42: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [168] { return newSym(sym.MULTEQ); }");
            { return newSym(sym.MULTEQ);
            }
          case 141: break;
          case 43: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [193] { yybegin(COMMENT); System.out.print(\"comment: \"); }");
            { yybegin(COMMENT); System.out.print("comment: ");
            }
          case 142: break;
          case 44: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [190] { System.out.print(\"comment line: \"); yybegin(LINE_COMMENT); }");
            { System.out.print("comment line: "); yybegin(LINE_COMMENT);
            }
          case 143: break;
          case 45: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [169] { return newSym(sym.DIVEQ); }");
            { return newSym(sym.DIVEQ);
            }
          case 144: break;
          case 46: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [112] { return newSym(sym.IF); }");
            { return newSym(sym.IF);
            }
          case 145: break;
          case 47: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [100] { return newSym(sym.DO); }");
            { return newSym(sym.DO);
            }
          case 146: break;
          case 48: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [163] { return newSym(sym.LSHIFT); }");
            { return newSym(sym.LSHIFT);
            }
          case 147: break;
          case 49: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [148] { return newSym(sym.LTEQ); }");
            { return newSym(sym.LTEQ);
            }
          case 148: break;
          case 50: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [173] { return newSym(sym.MODEQ); }");
            { return newSym(sym.MODEQ);
            }
          case 149: break;
          case 51: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [164] { return newSym(sym.RSHIFT); }");
            { return newSym(sym.RSHIFT);
            }
          case 150: break;
          case 52: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [149] { return newSym(sym.GTEQ); }");
            { return newSym(sym.GTEQ);
            }
          case 151: break;
          case 53: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [147] { return newSym(sym.EQEQ); }");
            { return newSym(sym.EQEQ);
            }
          case 152: break;
          case 54: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [150] { return newSym(sym.NOTEQ); }");
            { return newSym(sym.NOTEQ);
            }
          case 153: break;
          case 55: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [171] { return newSym(sym.OREQ); }");
            { return newSym(sym.OREQ);
            }
          case 154: break;
          case 56: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [152] { return newSym(sym.OROR); }");
            { return newSym(sym.OROR);
            }
          case 155: break;
          case 57: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [166] { return newSym(sym.PLUSEQ); }");
            { return newSym(sym.PLUSEQ);
            }
          case 156: break;
          case 58: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [153] { return newSym(sym.PLUSPLUS); }");
            { return newSym(sym.PLUSPLUS);
            }
          case 157: break;
          case 59: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [167] { return newSym(sym.MINUSEQ); }");
            { return newSym(sym.MINUSEQ);
            }
          case 158: break;
          case 60: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [154] { return newSym(sym.MINUSMINUS); }");
            { return newSym(sym.MINUSMINUS);
            }
          case 159: break;
          case 61: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [172] { return newSym(sym.XOREQ); }");
            { return newSym(sym.XOREQ);
            }
          case 160: break;
          case 62: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [201] { if (comment_nesting == 0) yybegin(YYINITIAL);comment_nesting--; }");
            { if (comment_nesting == 0) yybegin(YYINITIAL);comment_nesting--;
            }
          case 161: break;
          case 63: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [200] { comment_nesting++; System.out.println(\"comment_nesting: \" + comment_nesting); }");
            { comment_nesting++; System.out.println("comment_nesting: " + comment_nesting);
            }
          case 162: break;
          case 64: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [218] { buff.append(\'\\n\'); }");
            { buff.append('\n');
            }
          case 163: break;
          case 65: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [222] { buff.append(\'\\b\'); }");
            { buff.append('\b');
            }
          case 164: break;
          case 66: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [220] { buff.append(\'\\t\'); }");
            { buff.append('\t');
            }
          case 165: break;
          case 67: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [224] { buff.append(\'\\f\'); }");
            { buff.append('\f');
            }
          case 166: break;
          case 68: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [185] { return newSym(sym.CONSTANT, new Character(yytext().charAt(1))); }");
            { return newSym(sym.CONSTANT, new Character(yytext().charAt(1)));
            }
          case 167: break;
          case 69: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [109] { return newSym(sym.INT_TYPE); }");
            { return newSym(sym.INT_TYPE);
            }
          case 168: break;
          case 70: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [107] { return newSym(sym.FOR); }");
            { return newSym(sym.FOR);
            }
          case 169: break;
          case 71: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [174] { return newSym(sym.LSHIFTEQ); }");
            { return newSym(sym.LSHIFTEQ);
            }
          case 170: break;
          case 72: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [165] { return newSym(sym.URSHIFT); }");
            { return newSym(sym.URSHIFT);
            }
          case 171: break;
          case 73: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [175] { return newSym(sym.RSHIFTEQ); }");
            { return newSym(sym.RSHIFTEQ);
            }
          case 172: break;
          case 74: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [94] { return newSym(sym.BYTE); }");
            { return newSym(sym.BYTE);
            }
          case 173: break;
          case 75: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [102] { return newSym(sym.ELSE); }");
            { return newSym(sym.ELSE);
            }
          case 174: break;
          case 76: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [119] { return newSym(sym.THIS); }");
            { return newSym(sym.THIS);
            }
          case 175: break;
          case 77: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [95] { return newSym(sym.CASE); }");
            { return newSym(sym.CASE);
            }
          case 176: break;
          case 78: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [97] { return newSym(sym.CHAR_TYPE); }");
            { return newSym(sym.CHAR_TYPE);
            }
          case 177: break;
          case 79: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [110] { return newSym(sym.LONG_TYPE); }");
            { return newSym(sym.LONG_TYPE);
            }
          case 178: break;
          case 80: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [111] { return newSym(sym.GOTO); }");
            { return newSym(sym.GOTO);
            }
          case 179: break;
          case 81: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [116] { return newSym(sym.VOID); }");
            { return newSym(sym.VOID);
            }
          case 180: break;
          case 82: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [125] { return newSym(sym.NULL_LITERAL); }");
            { return newSym(sym.NULL_LITERAL);
            }
          case 181: break;
          case 83: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [176] { return newSym(sym.URSHIFTEQ); }");
            { return newSym(sym.URSHIFTEQ);
            }
          case 182: break;
          case 84: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [93] { return newSym(sym.BREAK); }");
            { return newSym(sym.BREAK);
            }
          case 183: break;
          case 85: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [96] { return newSym(sym.CATCH); }");
            { return newSym(sym.CATCH);
            }
          case 184: break;
          case 86: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [98] { return newSym(sym.CONST); }");
            { return newSym(sym.CONST);
            }
          case 185: break;
          case 87: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [113] { return newSym(sym.SHORT_TYPE); }");
            { return newSym(sym.SHORT_TYPE);
            }
          case 186: break;
          case 88: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [104] { return newSym(sym.FINAL); }");
            { return newSym(sym.FINAL);
            }
          case 187: break;
          case 89: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [106] { return newSym(sym.FLOAT_TYPE); }");
            { return newSym(sym.FLOAT_TYPE);
            }
          case 188: break;
          case 90: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [118] { return newSym(sym.WHILE); }");
            { return newSym(sym.WHILE);
            }
          case 189: break;
          case 91: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [115] { return newSym(sym.RETURN); }");
            { return newSym(sym.RETURN);
            }
          case 190: break;
          case 92: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [117] { return newSym(sym.STATIC); }");
            { return newSym(sym.STATIC);
            }
          case 191: break;
          case 93: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [114] { return newSym(sym.SWITCH); }");
            { return newSym(sym.SWITCH);
            }
          case 192: break;
          case 94: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [101] { return newSym(sym.DOUBLE_TYPE); }");
            { return newSym(sym.DOUBLE_TYPE);
            }
          case 193: break;
          case 95: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [103] { return newSym(sym.EXTENDS); }");
            { return newSym(sym.EXTENDS);
            }
          case 194: break;
          case 96: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [108] { return newSym(sym.DEFAULT); }");
            { return newSym(sym.DEFAULT);
            }
          case 195: break;
          case 97: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [105] { return newSym(sym.FINALLY); }");
            { return newSym(sym.FINALLY);
            }
          case 196: break;
          case 98: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [99] { return newSym(sym.CONTINUE); }");
            { return newSym(sym.CONTINUE);
            }
          case 197: break;
          case 99: 
            System.out.println("line: "+(yyline+1)+" "+"col: "+(yycolumn+1)+" "+"match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [120] { return newSym(sym.VOLATILE); }");
